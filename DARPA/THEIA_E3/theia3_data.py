...
# Source notebook : theia3_datapreprocess.ipynb
# Conversion time : 2025-09-21T10:20:47
# Kernel          : base
# Language        : python
#
# Notes:
#   - Markdown cells have been converted into commented blocks to preserve context.
#   - Code cells are separated with '# %%' markers for easy navigation in editors.
#   - If the notebook used line/cell magics (e.g., %time, %%bash), they are left as-is;
#     some may require Jupyter/IPython to execute correctly.
# ======================================================================
...
#
# Database setting - create DB and tables
#
import psycopg2
